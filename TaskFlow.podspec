#
#  Be sure to run `pod spec lint TaskFlow.podspec' to ensure this is a
...
DESC
  ...
  spec.source       = { :git => "https://github.com/liulcd/taskflow-swift.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Sources/TaskFlow/**/*.swift"
